...
- `usermeta.dysonsphere.provenance` — the generation facts as structured fields, in the same order as the text line (`user`, `script`, `timestamp` (ISO-8601), `python`, `altair`, `dysonsphere`), so you don't have to parse the text string.
